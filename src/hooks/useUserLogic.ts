...
export const useUserLogic = () => {
  ...
  const processUserLogic = async (userId: string): Promise<LogicState | null> => {
  ...
  const getUserLogicState = async (userId: string): Promise<LogicState | null> => {
    try {
  ...
  return {
    ...
    processClientLogic: processUserLogic,
    getClientLogicState: getUserLogicState
  };
};