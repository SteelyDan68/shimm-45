-- 🚀 PERFORMANCE OPTIMIZATION - KORRIGERADE DATABASE INDEXES
-- Phase 2: Database indexing med korrekta tabellnamn
...
-- 3. ASSESSMENT_ROUNDS OPTIMIZATION (korrigerat namn)
...
CREATE INDEX IF NOT EXISTS idx_assessment_rounds_pillar_type ON public.assessment_rounds (pillar_type, user_id);
...
CREATE INDEX IF NOT EXISTS idx_assessments_recent ON public.assessment_rounds (user_id, created_at DESC, pillar_type) 
...
-- 11. PATH_ENTRIES OPTIMIZATION
-- For user journey and progress tracking
