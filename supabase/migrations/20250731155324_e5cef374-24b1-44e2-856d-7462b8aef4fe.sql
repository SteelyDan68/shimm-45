-- Fix med korrekt category värde
...
-- 2. Skapa klient-post för stefan.hallgren@happyminds.com med korrekt category
...
-- 3. Ta bort user-rollen för happyminds användaren (behåll endast client)
