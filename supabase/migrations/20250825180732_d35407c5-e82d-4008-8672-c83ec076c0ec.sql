-- Create AI response logs table with properly structured policies
...
-- Allow anyone to insert response logs (edge functions may be public)
...
-- Anyone can insert/update rate limits (edge functions)
DROP POLICY IF EXISTS "ai_rate_limits_insert_all" ON public.ai_rate_limits;
CREATE POLICY "ai_rate_limits_insert_all"
