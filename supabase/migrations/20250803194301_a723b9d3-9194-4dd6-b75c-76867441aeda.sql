-- ========================================================
-- PHASE 1: ELIMINATE CLIENT_ID FROM DATABASE FOREVER
...
-- Update client_pillar_assignments: remove client_id column, rename to user_pillar_assignments
...
-- 5. Create function to get user context (roles and relationships)
...
-- 7. Update RLS policies to be user_id focused (will be done in separate migration)
-- This ensures all future development follows single source of truth principle