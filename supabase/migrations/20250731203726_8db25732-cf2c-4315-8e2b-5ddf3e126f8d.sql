-- STEP 2 (retry): Make user_id NOT NULL and remove client_id dependencies
-- Now that all user_id fields are populated and clean, make them required and drop client_id
