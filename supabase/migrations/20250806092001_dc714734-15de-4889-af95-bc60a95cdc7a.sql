-- Sprint 1: Stefan AI Messaging System Database Schema (Fixed)
-- Creates proper tables for Stefan interventions without invalid user references
...
SELECT 
  ...
  ROUND(
    (COUNT(*) FILTER (WHERE user_responded = true)::numeric / NULLIF(COUNT(*)::numeric, 0)) * 100, 2
